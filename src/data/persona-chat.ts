import type { PersonaChatKB } from "@/types/content";

export const personaChatKB: PersonaChatKB[] = [
  {
    ...
    kb: [
      ...
      "Isıtmalı gövde, nabız simülasyonu ve uyku modu opsiyoneldir.",
      "Bakım kitinde sabunsuz solüsyon ve mikrofiber bez yer alır.",
    ],
  },
  {
    ...
    kb: [
      ...
      "Refleks masaj başlığı ve uyku seremonisi kiti uyumludur.",
      "Garanti 18 ay, uygulama verileri şifrelenmiş şekilde saklanır.",
    ],
  },
  {
    ...
    kb: [
      ...
      "Shadow Case taşıma valizi ile seyahat etmek için idealdir.",
      "İade süresi 14 gündür, hijyen bandının açılmamış olması gerekir.",
    ],
  },
];
